...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/10/03 23:05:20 by chelee            #+#    #+#             */
/*   Updated: 2020/11/06 13:44:58 by chelee           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				handle_double_f(int exp,
		char *bits, char **f, char *big_int);
void				add_bigint(char **fraction, const char *big_int);
